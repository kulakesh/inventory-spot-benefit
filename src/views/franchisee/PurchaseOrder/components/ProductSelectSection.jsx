...
const ProductSelectSection = () => {
    ...
    const total = useMemo(() => {
        return selectedProduct.reduce((accumulator, product) => {
            return accumulator + product.amount * product.quantity * product.bundle
        }, 0)
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [selectedProduct, selectedProduct.length])
    const totalBv = useMemo(() => {
        return selectedProduct.reduce((accumulator, product) => {
            return accumulator + product.bv * product.quantity * product.bundle
        }, 0)
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [selectedProduct, selectedProduct.length])
